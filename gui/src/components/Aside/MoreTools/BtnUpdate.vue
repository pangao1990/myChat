<template>
  <div>
    <el-tooltip content="检测更新" placement="top" effect="light">
    ...
    <el-dialog v-model="state.checkVisible" title="检测更新" top="30vh" draggable destroy-on-close :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false">
      <div>
